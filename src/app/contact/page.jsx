          ...
          <div className="grid lg:grid-cols-12 gap-16 lg:gap-24 items-start pt-10">
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="lg:col-span-5">
              <div className="space-y-12 lg:space-y-16 lg:pr-8">
                ...
                {/* 1. Direct Inquiry */}
                <div>
                  <h3 className="text-emerald-600 text-xs font-bold uppercase tracking-[0.2em] mb-6">Direct Inquiry</h3>
                  <a href="mailto:hello@cyoumedia.com" className="text-3xl md:text-4xl font-semibold tracking-tight text-[#1d1d1f] hover:text-emerald-600 transition-colors duration-300 block mb-4">
                    hello@cyoumedia.com
                  </a>
                  <a href="tel:+4681234567" className="text-xl text-gray-500 font-light hover:text-[#1d1d1f] transition-colors duration-300 flex items-center gap-3 w-max">
                ...
                <div className="pt-10 border-t border-gray-100">
                  <h3 className="text-emerald-600 text-xs font-bold uppercase tracking-[0.2em] mb-6">Headquarters</h3>
                ...
                {/* 3. Social Icons */}
                <div className="pt-10 border-t border-gray-100">
                  <h3 className="text-emerald-600 text-xs font-bold uppercase tracking-[0.2em] mb-6">Connect</h3>
                  <div className="flex gap-4">
                    {/* LinkedIn */}
                    <a href="#" className="w-14 h-14 rounded-full border border-gray-200 flex items-center justify-center text-gray-500 hover:text-white hover:border-emerald-500 hover:bg-emerald-500 hover:-translate-y-1 transition-all duration-300 shadow-sm">
            ...
            <motion.div variants={fadeScale} initial="hidden" whileInView="visible" viewport={{ once: true }} className="lg:col-span-7">
              <form className="bg-white p-8 md:p-14 rounded-[3rem] shadow-[0_20px_80px_rgba(0,0,0,0.06)] border border-gray-100 space-y-8 relative overflow-hidden group">
                {/* Subtle Hover Glow behind form */}
                <div className="absolute -top-32 -right-32 w-64 h-64 bg-emerald-500/5 blur-[80px] rounded-full pointer-events-none group-hover:bg-emerald-500/10 transition-colors duration-700" />
                ...
                <div className="grid md:grid-cols-2 gap-8 relative z-10">
                  <div className="space-y-2">
                    ...
                    <input 
                      type="text" 
                      className="w-full bg-gray-50 border border-gray-100 rounded-2xl px-6 py-4 text-[#1d1d1f] focus:outline-none focus:border-emerald-500 focus:bg-white transition-all placeholder:text-gray-400" 
                ...
                <div className="space-y-2 relative z-10">
                  ...
                  <textarea 
                    rows="5" 
                    className="w-full bg-gray-50 border border-gray-100 rounded-2xl px-6 py-4 text-[#1d1d1f] focus:outline-none focus:border-emerald-500 focus:bg-white transition-all placeholder:text-gray-400 resize-none" 
                ...
                <button 
                  type="button" 
                  className="w-full bg-[#052824] text-white font-bold text-lg py-5 rounded-2xl hover:bg-emerald-600 transition-all hover:scale-[1.01] active:scale-[0.99] shadow-xl relative z-10"
                >

...
// Premium Wavy Line using #89cff1
...
export default function CareersList() {
  ...
  return (
    <div ref={containerRef} className="bg-[#020617] text-white font-sans selection:bg-[#89cff1]/30 overflow-hidden">
      
      {/* ================= 1. CINEMATIC HERO ================= */}
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
        <motion.div style={{ y }} className="absolute inset-0 z-0">
          <Image src="/bg.png" alt="Atmosphere" fill className="object-cover opacity-20 mix-blend-overlay" priority />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            <span className="text-[#89cff1] text-xs font-bold uppercase tracking-[0.5em] mb-8 block">Careers at CYouMedia</span>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-semibold tracking-tighter leading-[0.8] mb-12">
              Join the <span className="italic text-[#89cff1]">Elite.</span>
            </h1>
          ...
          <div className="grid lg:grid-cols-12 gap-24 items-start">
            ...
            <div className="lg:col-span-6 lg:sticky lg:top-40">
              <div className="flex items-center gap-4 mb-8">
                ...
                <span className="text-[#89cff1] text-xs font-bold uppercase tracking-[0.2em]">Our Manifesto</span>
              </div>
              <h2 className="text-6xl font-semibold tracking-tighter mb-10 leading-[1.05] text-[#020617]">
                Life inside <br /> <span className="text-[#89cff1]">CYouMedia.</span>
              </h2>
              <div className="space-y-8 text-2xl text-gray-400 font-light leading-relaxed">
                <p>
                  ...
                  <span className="text-[#020617] font-medium"> pragmatists and the visionaries </span> 
                ...
                <p>
                  ...
                  <span className="text-[#3ea6d6] font-medium italic"> transparency is our default </span> 
      ...
      <section className="bg-[#FAFAFA] py-40 px-6 lg:px-12 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="flex justify-between items-end mb-20">
            <h2 className="text-5xl font-semibold tracking-tighter text-[#020617]">Open Positions</h2>
            <div className="text-[#3ea6d6] font-mono text-sm tracking-widest uppercase">[ {careersData.length} Positions ]</div>
          </div>
          ...
          <div className="space-y-4">
            {careersData.map((job) => (
              ...
              >
                <Link href={`/careers/${job.id}`} className="group flex flex-col md:flex-row items-center justify-between p-10 md:p-14 bg-white hover:bg-[#020617] transition-colors duration-500 rounded-[3rem] shadow-sm hover:shadow-2xl border border-gray-100 hover:border-transparent">
                  <div className="flex-1">
                    <span className="text-[10px] font-bold uppercase tracking-widest text-[#89cff1] mb-4 block group-hover:text-[#89cff1]">
                      {job.department} • {job.location}
                    </span>
                    <h3 className="text-4xl font-semibold tracking-tighter text-[#020617] group-hover:text-white transition-colors">
                      {job.title}
                    </h3>
                  </div>
                  
                  <div className="mt-8 md:mt-0 w-16 h-16 rounded-full border border-gray-100 flex items-center justify-center group-hover:bg-[#89cff1] group-hover:border-[#89cff1] transition-all">
                    <svg className="w-6 h-6 text-gray-300 group-hover:text-[#020617]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
